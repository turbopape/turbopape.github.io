...
var o__64993__auto__ = (function (){var temp__4657__auto__ = goog.object.get(window,"cljs");
if(cljs.core.truth_(temp__4657__auto__)){
var o__65005__auto__ = temp__4657__auto__;
return goog.object.get(o__65005__auto__,"core");
} else {
return null;
}
})();
return goog.object.get(o__64993__auto__,"js_reserved_QMARK_").call(o__64993__auto__,x);
});
devtools.munging.get_fn_source_safely = (function devtools$munging$get_fn_source_safely(f){
try{var o__64993__auto__ = f;
return goog.object.get(o__64993__auto__,"toString").call(o__64993__auto__);
}catch (e67219){var _ = e67219;
return "";
}});
...
try{var o__64993__auto___67222 = t;
goog.object.get(o__64993__auto___67222,"cljs$lang$ctorPrWriter").call(o__64993__auto___67222,t,writer);
}catch (e67221){var __67223 = e67221;
}
...
var char_code = (function (){var o__64993__auto__ = (new String(char$));
return goog.object.get(o__64993__auto__,"charCodeAt").call(o__64993__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__64993__auto__ = String;
return goog.object.get(o__64993__auto__,"fromCharCode").call(o__64993__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__67225 = num_code;
switch (G__67225) {
case (1):
return (185);
...
var o__64993__auto__ = String;
return goog.object.get(o__64993__auto__,"fromCharCode").call(o__64993__auto__,superscript_code);
});
/**
...
}catch (e67231){var e__65018__auto__ = e67231;
return false;
}})())){
...
var vec__67232 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__67232,(0),null);
...
var or__44267__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
var temp__4657__auto____$1 = goog.object.get(o__65006__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__65005__auto__ = temp__4657__auto____$1;
return goog.object.get(o__65005__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__45375__auto___67241 = arguments.length;
var i__45376__auto___67242 = (0);
while(true){
if((i__45376__auto___67242 < len__45375__auto___67241)){
args__45382__auto__.push((arguments[i__45376__auto___67242]));

var G__67243 = (i__45376__auto___67242 + (1));
i__45376__auto___67242 = G__67243;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45383__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__67237){
var vec__67238 = p__67237;
var ns_detector = cljs.core.nth.call(null,vec__67238,(0),null);
var effective_detector = (function (){var or__44267__auto__ = ns_detector;
if(cljs.core.truth_(or__44267__auto__)){
return or__44267__auto__;
} else {
...
var G__67244 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__67245 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__67244;
remaining_tokens = G__67245;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq67235){
var G__67236 = cljs.core.first.call(null,seq67235);
var seq67235__$1 = cljs.core.next.call(null,seq67235);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__67236,seq67235__$1);
});
...
break;
default:
var o__64993__auto__ = window;
return goog.object.get(o__64993__auto__,"parseInt").call(o__64993__auto__,arity,(10));
...
var vec__67253 = cljs.core.split_with.call(null,(function (p1__67249_SHARP_){
return cljs.core.not_EQ_.call(null,p1__67249_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__67253,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__67253,(1),null);
...
var vec__67259 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__67259,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__67259,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__67262 = cljs.core.rest.call(null,remaining_tokens);
var G__67263 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__67262;
name_tokens = G__67263;
continue;
} else {
...
var args67264 = [];
var len__45375__auto___67276 = arguments.length;
var i__45376__auto___67277 = (0);
while(true){
if((i__45376__auto___67277 < len__45375__auto___67276)){
args67264.push((arguments[i__45376__auto___67277]));

var G__67278 = (i__45376__auto___67277 + (1));
i__45376__auto___67277 = G__67278;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args67264.length)].join('')));
...
var vec__67267 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__67267,(0),null);
var arity = cljs.core.nth.call(null,vec__67267,(1),null);
var vec__67270 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__67270,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__67270,(1),null);
var vec__67273 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__67273,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__67273,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__67273,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__67273,(3),null);
...
var args67280 = [];
var len__45375__auto___67286 = arguments.length;
var i__45376__auto___67287 = (0);
while(true){
if((i__45376__auto___67287 < len__45375__auto___67286)){
args67280.push((arguments[i__45376__auto___67287]));

var G__67288 = (i__45376__auto___67287 + (1));
i__45376__auto___67287 = G__67288;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args67280.length)].join('')));
...
var vec__67283 = result;
var munged_ns = cljs.core.nth.call(null,vec__67283,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__67283,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__67283,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__67283,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__67283,(4),null);
var arity = cljs.core.nth.call(null,vec__67283,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__67296 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__67296,(0),null);
var args = cljs.core.nth.call(null,vec__67296,(1),null);
var vec__67299 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__67299,(0),null);
var name = cljs.core.nth.call(null,vec__67299,(1),null);
...
var G__67302 = (arity + (1));
var G__67303 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__67304){
var vec__67308 = p__67304;
var arity = cljs.core.nth.call(null,vec__67308,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__67308,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__44267__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__44267__auto__)){
return or__44267__auto__;
} else {
...
return (function (p1__67311_SHARP_){
return cljs.core.get.call(null,arities,p1__67311_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__67312_SHARP_){
return cljs.core.drop.call(null,(2),p1__67312_SHARP_);
...
var args__45382__auto__ = [];
var len__45375__auto___67319 = arguments.length;
var i__45376__auto___67320 = (0);
while(true){
if((i__45376__auto___67320 < len__45375__auto___67319)){
args__45382__auto__.push((arguments[i__45376__auto___67320]));

var G__67321 = (i__45376__auto___67320 + (1));
i__45376__auto___67320 = G__67321;
continue;
} else {
}
break;
...
var argseq__45383__auto__ = ((((1) < args__45382__auto__.length))?(new cljs.core.IndexedSeq(args__45382__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45383__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__67315){
var vec__67316 = p__67315;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__67316,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq67313){
var G__67314 = cljs.core.first.call(null,seq67313);
var seq67313__$1 = cljs.core.next.call(null,seq67313);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__67314,seq67313__$1);
});
...
var G__67323 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__67323) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__44267__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__44267__auto__)){
return or__44267__auto__;
} else {
...
return [cljs.core.str((cljs.core.truth_((function (){var and__44255__auto__ = include_ns_QMARK_;
...
return [cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str(protocol_name)].join(''):null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str((cljs.core.truth_((function (){var or__44267__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__44267__auto__)){
return or__44267__auto__;
} else {
...
var map__67330 = options;
var map__67330__$1 = ((((!((map__67330 == null)))?((((map__67330.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67330.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__67330):map__67330);
var include_ns_QMARK_ = cljs.core.get.call(null,map__67330__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__67330__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__67330__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__67330__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__67331 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__67331,(0),null);
var fn_name = cljs.core.nth.call(null,vec__67331,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__67331,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__67331,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__67331,(4),null);
var arity = cljs.core.nth.call(null,vec__67331,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__44255__auto__ = protocol_ns;
if(cljs.core.truth_(and__44255__auto__)){
return cljs.core.not.call(null,(function (){var and__44255__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str((function (){var or__44267__auto__ = protocol_part;
if(cljs.core.truth_(or__44267__auto__)){
return or__44267__auto__;
} else {
return fn_part;
...
var o__64993__auto__ = f;
return goog.object.get(o__64993__auto__,"getBasis").call(o__64993__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__44255__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__44255__auto__)){
...
}catch (e67336){var e__65018__auto__ = e67336;
...
var G__67337 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__67338 = cljs.core.rest.call(null,path);
obj = G__67337;
path = G__67338;
continue;
} else {
...
var partition_bits = (function (){var or__44267__auto__ = goog.object.get(obj,partition_key);
if(cljs.core.truth_(or__44267__auto__)){
return or__44267__auto__;
} else {
return (0);
...
return (function (accum,p__67343){
var vec__67344 = p__67343;
var bit = cljs.core.nth.call(null,vec__67344,(0),null);
var protocol = cljs.core.nth.call(null,vec__67344,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__67347){
var vec__67351 = p__67347;
var ns = cljs.core.nth.call(null,vec__67351,(0),null);
var name = cljs.core.nth.call(null,vec__67351,(1),null);
var selector = cljs.core.nth.call(null,vec__67351,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__67360,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__67360,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__67360,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__67354_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__67354_SHARP_));
});})(name,sorted_matches,vec__67360,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1476929182027