...
var len__45375__auto___67406 = arguments.length;
var i__45376__auto___67407 = (0);
while(true){
if((i__45376__auto___67407 < len__45375__auto___67406)){
args__45382__auto__.push((arguments[i__45376__auto___67407]));

var G__67408 = (i__45376__auto___67407 + (1));
i__45376__auto___67407 = G__67408;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__45383__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq67403){
var G__67404 = cljs.core.first.call(null,seq67403);
var seq67403__$1 = cljs.core.next.call(null,seq67403);
var G__67405 = cljs.core.first.call(null,seq67403__$1);
var seq67403__$2 = cljs.core.next.call(null,seq67403__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__67404,G__67405,seq67403__$2);
});
...
if(cljs.core.truth_((function (){var or__44267__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__44873__auto__,writer__44874__auto__,opt__44875__auto__){
return cljs.core._write.call(null,writer__44874__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__44255__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__44255__auto__){
var or__44267__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__44267__auto__)){
return or__44267__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__67409_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__67409_SHARP_));
})))){
...
var map__67418 = opts;
var map__67418__$1 = ((((!((map__67418 == null)))?((((map__67418.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67418.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__67418):map__67418);
var markup_db = cljs.core.get.call(null,map__67418__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__44267__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e67422){var e__65018__auto__ = e67422;
return false;
}})();
if(cljs.core.truth_(or__44267__auto__)){
return or__44267__auto__;
...
}catch (e67424){var e__65018__auto__ = e67424;
return false;
}}
})())){
...
var _STAR_current_state_STAR_67429 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__67430 = opts;
var map__67430__$1 = ((((!((map__67430 == null)))?((((map__67430.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67430.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__67430):map__67430);
var markup_db = cljs.core.get.call(null,map__67430__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_67429;
}});
...
;
var temp__4655__auto___67435 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___67435)){
var managed_print_level_67436 = temp__4655__auto___67435;
var _STAR_print_level_STAR_67434_67437 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_67436;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_67434_67437,managed_print_level_67436,temp__4655__auto___67435,writer,opts,job_fn){
return (function (p1__67432_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__67432_SHARP_,null);
});})(_STAR_print_level_STAR_67434_67437,managed_print_level_67436,temp__4655__auto___67435,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_67434_67437;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1476929182430