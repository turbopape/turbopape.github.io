...
var len__45375__auto___67397 = arguments.length;
var i__45376__auto___67398 = (0);
while(true){
if((i__45376__auto___67398 < len__45375__auto___67397)){
args__45382__auto__.push((arguments[i__45376__auto___67398]));

var G__67399 = (i__45376__auto___67398 + (1));
i__45376__auto___67398 = G__67399;
continue;
} else {
}
break;
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq67395){
var G__67396 = cljs.core.first.call(null,seq67395);
var seq67395__$1 = cljs.core.next.call(null,seq67395);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__67396,seq67395__$1);
});
...
return (p1__67400_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1476929182243