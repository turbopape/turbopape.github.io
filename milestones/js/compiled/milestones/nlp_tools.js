...
var G__55887 = cljs.core.rest.call(null,tag_stack);
tag_stack = G__55887;
continue;
}
} else {
...
var input_items = cljs.core.filter.call(null,cljs.core.comp.call(null,cljs.core.not,cljs.core.empty_QMARK_,(function (p1__55888_SHARP_){
return cljs.core.get.call(null,p1__55888_SHARP_,(1));
...
var map__55891 = milestones.nlp_tools.accept_tag.call(null,input_item,tag_stack);
var map__55891__$1 = ((((!((map__55891 == null)))?((((map__55891.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55891.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55891):map__55891);
var accept_QMARK_ = map__55891__$1;
var step = cljs.core.get.call(null,map__55891__$1,new cljs.core.Keyword(null,"step","step",1288888124));
var new_stack = cljs.core.get.call(null,map__55891__$1,new cljs.core.Keyword(null,"new-stack","new-stack",1596588953));
if(cljs.core.truth_(step)){
var G__55893 = input_items;
var G__55894 = new_stack;
var G__55895 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"step","step",1288888124),step,new cljs.core.Keyword(null,"items","items",1031954938),cljs.core.PersistentVector.EMPTY], null);
var G__55896 = ((cljs.core.empty_QMARK_.call(null,cljs.core.get.call(null,output_stack,new cljs.core.Keyword(null,"items","items",1031954938))))?output:cljs.core.assoc.call(null,output,cljs.core.get.call(null,output_stack,new cljs.core.Keyword(null,"step","step",1288888124)),cljs.core.get.call(null,output_stack,new cljs.core.Keyword(null,"items","items",1031954938))));
input_items = G__55893;
tag_stack = G__55894;
output_stack = G__55895;
output = G__55896;
continue;
} else {
...
var G__55897 = input_items;
var G__55898 = ffw_stack;
var G__55899 = output_stack;
var G__55900 = output;
input_items = G__55897;
tag_stack = G__55898;
output_stack = G__55899;
output = G__55900;
continue;
} else {
...
var G__55905 = cljs.core.rest.call(null,rem_rules);
var G__55906 = cljs.core.conj.call(null,errors,err);
rem_rules = G__55905;
errors = G__55906;
continue;
} else {
...
var map__55910 = a_task;
var map__55910__$1 = ((((!((map__55910 == null)))?((((map__55910.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55910.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55910):map__55910);
var task_id = cljs.core.get.call(null,map__55910__$1,new cljs.core.Keyword(null,"task-id","task-id",-1045480126));
var task_name = cljs.core.get.call(null,map__55910__$1,new cljs.core.Keyword(null,"task-name","task-name",226705458));
var resource_id = cljs.core.get.call(null,map__55910__$1,new cljs.core.Keyword(null,"resource-id","resource-id",-1308422582));
var duration = cljs.core.get.call(null,map__55910__$1,new cljs.core.Keyword(null,"duration","duration",1444101068));
var predecessors = cljs.core.get.call(null,map__55910__$1,new cljs.core.Keyword(null,"predecessors","predecessors",229913357));
var priority = cljs.core.get.call(null,map__55910__$1,new cljs.core.Keyword(null,"priority","priority",1431093715));
var milestone_id = cljs.core.get.call(null,map__55910__$1,new cljs.core.Keyword(null,"milestone-id","milestone-id",1545673291));
var regN = RegExp("\\d+","g");
...
return (function (p1__55912_SHARP_){
return milestones.nlp_tools.guess_a_task.call(null,p1__55912_SHARP_,optional_steps);
});})(sentences))
,sentences));
});

//# sourceMappingURL=nlp_tools.js.map?rel=1476929160556