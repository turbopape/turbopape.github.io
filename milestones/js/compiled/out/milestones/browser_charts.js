...
var vec__46424 = cljs.core.first.call(null,remaining_tasks);
var task_id = cljs.core.nth.call(null,vec__46424,(0),null);
var map__46427 = cljs.core.nth.call(null,vec__46424,(1),null);
...
var task_infos = map__46427__$1;
var task_name = cljs.core.get.call(null,map__46427__$1,new cljs.core.Keyword(null,"task-name","task-name",226705458));
var achieved = cljs.core.get.call(null,map__46427__$1,new cljs.core.Keyword(null,"achieved","achieved",-1236312021));
var begin = cljs.core.get.call(null,map__46427__$1,new cljs.core.Keyword(null,"begin","begin",-319034319));
var duration = cljs.core.get.call(null,map__46427__$1,new cljs.core.Keyword(null,"duration","duration",1444101068));
var duration_unit = cljs.core.get.call(null,map__46427__$1,new cljs.core.Keyword(null,"duration-unit","duration-unit",338651749));
var resource_id = cljs.core.get.call(null,map__46427__$1,new cljs.core.Keyword(null,"resource-id","resource-id",-1308422582));
var predecessors = cljs.core.get.call(null,map__46427__$1,new cljs.core.Keyword(null,"predecessors","predecessors",229913357));
var time_units = (cljs.core.truth_(duration_unit)?[cljs.core.str(duration_unit),cljs.core.str("s")].join(''):default_units);
var G__46429 = cljs.core.rest.call(null,remaining_tasks);
var G__46430 = cljs.core.conj.call(null,formatted_rows,new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str(task_id)].join(''),task_name,resource_id,moment(schedule_begin).add((begin - (1)),time_units),moment(schedule_begin).add(((begin + duration) - (1)),time_units),(cljs.core.truth_(duration)?moment.duration(duration,time_units).asMilliseconds():(0)),(((100) * (achieved / duration)) | (0)),((cljs.core.empty_QMARK_.call(null,predecessors))?null:(function (){var p = predecessors;
...
remaining_tasks = G__46429;
formatted_rows = G__46430;
continue;
} else {
...
var G__46432_46433 = data;
G__46432_46433.addColumn("string","Task ID");

G__46432_46433.addColumn("string","Task Name");

G__46432_46433.addColumn("string","Resource");

G__46432_46433.addColumn("date","Start Date");

G__46432_46433.addColumn("date","End Date");

G__46432_46433.addColumn("number","Duration");

G__46432_46433.addColumn("number","Percent Complete");

G__46432_46433.addColumn("string","Dependencies");
...
//# sourceMappingURL=browser_charts.js.map?rel=1476916463959