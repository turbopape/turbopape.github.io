...
return cljs.core.vec.call(null,cljs.core.mapcat.call(null,(function (p1__54271_SHARP_){
var the_id = p1__54271_SHARP_;
var the_task = cljs.core.get.call(null,tasks,p1__54271_SHARP_);
...
return cljs.core._EQ_.call(null,p1__54272_SHARP_.call(null,new cljs.core.Keyword(null,"task-id","task-id",-1045480126)),the_task_id);
});})(the_task,duration))
,output_schedule));
return (nb_task_units_in_output / duration);
}catch (e54274){if((e54274 instanceof Error)){
var e = e54274;
return (1);
} else {
throw e54274;
...
return cljs.core.count.call(null,cljs.core.take_while.call(null,(function (p1__54275_SHARP_){
return cljs.core._EQ_.call(null,the_task_id,p1__54275_SHARP_);
...
return cljs.core.vec.call(null,cljs.core.mapcat.call(null,(function (p1__54276_SHARP_){
return cljs.core.map.call(null,cljs.core.comp.call(null,p1__54276_SHARP_,cljs.core.val),row_with_index);
}),property_names));
});
});
/**
...
return cljs.core.vec.call(null,cljs.core.reverse.call(null,cljs.core.mapcat.call(null,cljs.core.keys,cljs.core.sort_by.call(null,milestones.dyna_scheduler.properties.call(null,property_names),cljs.core.map.call(null,(function (p__54281){
...
return cljs.core.filter.call(null,(function (p1__54285_SHARP_){
return cljs.core._EQ_.call(null,resource_id,new cljs.core.Keyword(null,"resource-id","resource-id",-1308422582).cljs$core$IFn$_invoke$arity$1(cljs.core.val.call(null,p1__54285_SHARP_)));
}),tasks);
});
/**
...
return cljs.core.vec.call(null,cljs.core.map.call(null,new cljs.core.Keyword(null,"time","time",1385887882),(function (p1__54286_SHARP_){
return cljs.core.get.call(null,p1__54286_SHARP_,task_id);
...
var vec__54290 = a_task;
var k = cljs.core.nth.call(null,vec__54290,(0),null);
var v = cljs.core.nth.call(null,vec__54290,(1),null);
...
return cljs.core.not.call(null,milestones.dyna_scheduler.task_complete_QMARK_.call(null,tasks,current_output_schedule,cljs.core.key.call(null,p1__54293_SHARP_)));
...
return cljs.core._EQ_.call(null,p1__54294_SHARP_,fireable_id_in_wp);
...
var G__54295 = tasks;
var G__54296 = reordering_properties;
var G__54297 = timer;
var G__54298 = cljs.core.rest.call(null,resources_ids);
var G__54299 = (function (){var new_task_unit = cljs.core.get.call(null,new_system_status,new cljs.core.Keyword(null,"task-unit","task-unit",-1936819158));
...
var G__54300 = cljs.core.get.call(null,new_system_status,new cljs.core.Keyword(null,"new-workflows","new-workflows",92241652));
tasks = G__54295;
reordering_properties = G__54296;
timer = G__54297;
resources_ids = G__54298;
output_schedule = G__54299;
workflows = G__54300;
continue;
} else {
...
var map__54303 = move_system_status.call(null,timer,resources_ids,output_schedule,workflows);
var map__54303__$1 = ((((!((map__54303 == null)))?((((map__54303.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54303.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__54303):map__54303);
var new_output_schedule = cljs.core.get.call(null,map__54303__$1,new cljs.core.Keyword(null,"new-output-schedule","new-output-schedule",-1227709275));
var new_workflows = cljs.core.get.call(null,map__54303__$1,new cljs.core.Keyword(null,"new-workflows","new-workflows",92241652));
var G__54305 = (timer + (1));
var G__54306 = new_workflows;
var G__54307 = new_output_schedule;
timer = G__54305;
workflows = G__54306;
output_schedule = G__54307;
continue;
} else {
...
return cljs.core.vec.call(null,cljs.core.filter.call(null,cljs.core.comp.call(null,cljs.core.not,cljs.core.nil_QMARK_),cljs.core.map.call(null,(function (p1__54308_SHARP_){
if(cljs.core.truth_(cljs.core.comp.call(null,cljs.core.not,cljs.core.partial.call(null,cljs.core.contains_QMARK_,task)).call(null,p1__54308_SHARP_))){
return p1__54308_SHARP_;
} else {
return null;
}
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__45050__auto__ = (function milestones$dyna_scheduler$tasks_w_missing_properties_$_iter__54325(s__54326){
return (new cljs.core.LazySeq(null,(function (){
var s__54326__$1 = s__54326;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__54326__$1);
if(temp__4657__auto__){
var s__54326__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__54326__$2)){
var c__45048__auto__ = cljs.core.chunk_first.call(null,s__54326__$2);
var size__45049__auto__ = cljs.core.count.call(null,c__45048__auto__);
var b__54328 = cljs.core.chunk_buffer.call(null,size__45049__auto__);
if((function (){var i__54327 = (0);
while(true){
if((i__54327 < size__45049__auto__)){
var vec__54335 = cljs.core._nth.call(null,c__45048__auto__,i__54327);
var id = cljs.core.nth.call(null,vec__54335,(0),null);
var t = cljs.core.nth.call(null,vec__54335,(1),null);
...
cljs.core.chunk_append.call(null,b__54328,cljs.core.PersistentArrayMap.fromArray([id,missing_props], true, false));

var G__54341 = (i__54327 + (1));
i__54327 = G__54341;
continue;
} else {
var G__54342 = (i__54327 + (1));
i__54327 = G__54342;
continue;
}
} else {
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__54328),milestones$dyna_scheduler$tasks_w_missing_properties_$_iter__54325.call(null,cljs.core.chunk_rest.call(null,s__54326__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__54328),null);
}
} else {
var vec__54338 = cljs.core.first.call(null,s__54326__$2);
var id = cljs.core.nth.call(null,vec__54338,(0),null);
var t = cljs.core.nth.call(null,vec__54338,(1),null);
var missing_props = milestones.dyna_scheduler.missing_prop_for_task.call(null,t,reordering_properties);
if(cljs.core.seq.call(null,missing_props)){
return cljs.core.cons.call(null,cljs.core.PersistentArrayMap.fromArray([id,missing_props], true, false),milestones$dyna_scheduler$tasks_w_missing_properties_$_iter__54325.call(null,cljs.core.rest.call(null,s__54326__$2)));
} else {
var G__54343 = cljs.core.rest.call(null,s__54326__$2);
s__54326__$1 = G__54343;
continue;
}
}
} else {
...
return cljs.core.keys.call(null,cljs.core.filter.call(null,(function (p__54348){
var vec__54349 = p__54348;
var _ = cljs.core.nth.call(null,vec__54349,(0),null);
var t = cljs.core.nth.call(null,vec__54349,(1),null);
...
return cljs.core.vec.call(null,cljs.core.keys.call(null,cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.filter.call(null,cljs.core.comp.call(null,cljs.core.empty_QMARK_,cljs.core.val),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__54356){
var vec__54357 = p__54356;
var id = cljs.core.nth.call(null,vec__54357,(0),null);
var t = cljs.core.nth.call(null,vec__54357,(1),null);
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.filter.call(null,cljs.core.comp.call(null,cljs.core.seq,(function (p1__54360_SHARP_){
return cljs.core.get.call(null,p1__54360_SHARP_,(1));
})),cljs.core.map.call(null,(function (p__54365){
var vec__54366 = p__54365;
var id = cljs.core.nth.call(null,vec__54366,(0),null);
var t = cljs.core.nth.call(null,vec__54366,(1),null);
...
return (function (p__54373){
var vec__54374 = p__54373;
var id = cljs.core.nth.call(null,vec__54374,(0),null);
var t = cljs.core.nth.call(null,vec__54374,(1),null);
...
//# sourceMappingURL=dyna_scheduler.js.map?rel=1476918237797