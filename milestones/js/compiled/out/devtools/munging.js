...
var o__55950__auto__ = (function (){var temp__4657__auto__ = goog.object.get(window,"cljs");
if(cljs.core.truth_(temp__4657__auto__)){
var o__55962__auto__ = temp__4657__auto__;
return goog.object.get(o__55962__auto__,"core");
} else {
return null;
}
})();
return goog.object.get(o__55950__auto__,"js_reserved_QMARK_").call(o__55950__auto__,x);
});
devtools.munging.get_fn_source_safely = (function devtools$munging$get_fn_source_safely(f){
try{var o__55950__auto__ = f;
return goog.object.get(o__55950__auto__,"toString").call(o__55950__auto__);
}catch (e58225){var _ = e58225;
return "";
}});
...
try{var o__55950__auto___58228 = t;
goog.object.get(o__55950__auto___58228,"cljs$lang$ctorPrWriter").call(o__55950__auto___58228,t,writer);
}catch (e58227){var __58229 = e58227;
}
...
var char_code = (function (){var o__55950__auto__ = (new String(char$));
return goog.object.get(o__55950__auto__,"charCodeAt").call(o__55950__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__55950__auto__ = String;
return goog.object.get(o__55950__auto__,"fromCharCode").call(o__55950__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__58231 = num_code;
switch (G__58231) {
case (1):
return (185);
...
var o__55950__auto__ = String;
return goog.object.get(o__55950__auto__,"fromCharCode").call(o__55950__auto__,superscript_code);
});
/**
...
}catch (e58237){var e__55975__auto__ = e58237;
return false;
}})())){
...
var vec__58238 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__58238,(0),null);
...
var temp__4657__auto____$1 = goog.object.get(o__55963__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__55962__auto__ = temp__4657__auto____$1;
return goog.object.get(o__55962__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__45375__auto___58247 = arguments.length;
var i__45376__auto___58248 = (0);
while(true){
if((i__45376__auto___58248 < len__45375__auto___58247)){
args__45382__auto__.push((arguments[i__45376__auto___58248]));

var G__58249 = (i__45376__auto___58248 + (1));
i__45376__auto___58248 = G__58249;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__58243){
var vec__58244 = p__58243;
var ns_detector = cljs.core.nth.call(null,vec__58244,(0),null);
...
var G__58250 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__58251 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__58250;
remaining_tokens = G__58251;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq58241){
var G__58242 = cljs.core.first.call(null,seq58241);
var seq58241__$1 = cljs.core.next.call(null,seq58241);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__58242,seq58241__$1);
});
...
break;
default:
var o__55950__auto__ = window;
return goog.object.get(o__55950__auto__,"parseInt").call(o__55950__auto__,arity,(10));
...
var vec__58259 = cljs.core.split_with.call(null,(function (p1__58255_SHARP_){
return cljs.core.not_EQ_.call(null,p1__58255_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__58259,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__58259,(1),null);
...
var vec__58265 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__58265,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__58265,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__58268 = cljs.core.rest.call(null,remaining_tokens);
var G__58269 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__58268;
name_tokens = G__58269;
continue;
} else {
...
var args58270 = [];
var len__45375__auto___58282 = arguments.length;
var i__45376__auto___58283 = (0);
while(true){
if((i__45376__auto___58283 < len__45375__auto___58282)){
args58270.push((arguments[i__45376__auto___58283]));

var G__58284 = (i__45376__auto___58283 + (1));
i__45376__auto___58283 = G__58284;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args58270.length)].join('')));
...
var vec__58273 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__58273,(0),null);
var arity = cljs.core.nth.call(null,vec__58273,(1),null);
var vec__58276 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__58276,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__58276,(1),null);
var vec__58279 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__58279,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__58279,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__58279,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__58279,(3),null);
...
var args58286 = [];
var len__45375__auto___58292 = arguments.length;
var i__45376__auto___58293 = (0);
while(true){
if((i__45376__auto___58293 < len__45375__auto___58292)){
args58286.push((arguments[i__45376__auto___58293]));

var G__58294 = (i__45376__auto___58293 + (1));
i__45376__auto___58293 = G__58294;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args58286.length)].join('')));
...
var vec__58289 = result;
var munged_ns = cljs.core.nth.call(null,vec__58289,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__58289,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__58289,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__58289,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__58289,(4),null);
var arity = cljs.core.nth.call(null,vec__58289,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__58302 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__58302,(0),null);
var args = cljs.core.nth.call(null,vec__58302,(1),null);
var vec__58305 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__58305,(0),null);
var name = cljs.core.nth.call(null,vec__58305,(1),null);
...
var G__58308 = (arity + (1));
var G__58309 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__58310){
var vec__58314 = p__58310;
var arity = cljs.core.nth.call(null,vec__58314,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__58314,(1),null);
...
return (function (p1__58317_SHARP_){
return cljs.core.get.call(null,arities,p1__58317_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__58318_SHARP_){
return cljs.core.drop.call(null,(2),p1__58318_SHARP_);
...
var args__45382__auto__ = [];
var len__45375__auto___58325 = arguments.length;
var i__45376__auto___58326 = (0);
while(true){
if((i__45376__auto___58326 < len__45375__auto___58325)){
args__45382__auto__.push((arguments[i__45376__auto___58326]));

var G__58327 = (i__45376__auto___58326 + (1));
i__45376__auto___58326 = G__58327;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__58321){
var vec__58322 = p__58321;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__58322,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq58319){
var G__58320 = cljs.core.first.call(null,seq58319);
var seq58319__$1 = cljs.core.next.call(null,seq58319);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__58320,seq58319__$1);
});
...
var G__58329 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__58329) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__58336__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__58336__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__58336__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__58336__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__58337 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__58337,(0),null);
var fn_name = cljs.core.nth.call(null,vec__58337,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__58337,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__58337,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__58337,(4),null);
var arity = cljs.core.nth.call(null,vec__58337,(5),null);
...
var o__55950__auto__ = f;
return goog.object.get(o__55950__auto__,"getBasis").call(o__55950__auto__);
});
/**
...
}catch (e58342){var e__55975__auto__ = e58342;
...
var G__58343 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__58344 = cljs.core.rest.call(null,path);
obj = G__58343;
path = G__58344;
continue;
} else {
...
return (function (accum,p__58349){
var vec__58350 = p__58349;
var bit = cljs.core.nth.call(null,vec__58350,(0),null);
var protocol = cljs.core.nth.call(null,vec__58350,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__58353){
var vec__58357 = p__58353;
var ns = cljs.core.nth.call(null,vec__58357,(0),null);
var name = cljs.core.nth.call(null,vec__58357,(1),null);
var selector = cljs.core.nth.call(null,vec__58357,(2),null);
...
return (function (p__58365){
var vec__58366 = p__58365;
var munged_name = cljs.core.nth.call(null,vec__58366,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__58366,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__58366,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__58360_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__58360_SHARP_));
});})(name,sorted_matches,vec__58366,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1476916485002