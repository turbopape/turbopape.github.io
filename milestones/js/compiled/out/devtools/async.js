...
var o__55950__auto___59143 = (function (){var o__55950__auto__ = (function (){var o__55950__auto__ = Promise;
return goog.object.get(o__55950__auto__,"resolve").call(o__55950__auto__);
})();
return goog.object.get(o__55950__auto__,"then").call(o__55950__auto__,callback);
})();
goog.object.get(o__55950__auto___59143,"catch").call(o__55950__auto___59143,devtools.async.rethrow_outside_promise);
...
var G__59145_59146 = Error;
var target__55969__auto___59147 = G__59145_59146;
if(cljs.core.truth_(target__55969__auto___59147)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__59145_59146)].join('')),cljs.core.str("\n"),cljs.core.str("target__55969__auto__")].join('')));
}

goog.object.set(target__55969__auto___59147,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1476916486987