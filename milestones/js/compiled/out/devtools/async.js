...
var o__64993__auto___67888 = (function (){var o__64993__auto__ = (function (){var o__64993__auto__ = Promise;
return goog.object.get(o__64993__auto__,"resolve").call(o__64993__auto__);
})();
return goog.object.get(o__64993__auto__,"then").call(o__64993__auto__,callback);
})();
goog.object.get(o__64993__auto___67888,"catch").call(o__64993__auto___67888,devtools.async.rethrow_outside_promise);
...
var G__67890_67891 = Error;
var target__65012__auto___67892 = G__67890_67891;
if(cljs.core.truth_(target__65012__auto___67892)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__67890_67891)].join('')),cljs.core.str("\n"),cljs.core.str("target__65012__auto__")].join('')));
}

goog.object.set(target__65012__auto___67892,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1476929183729