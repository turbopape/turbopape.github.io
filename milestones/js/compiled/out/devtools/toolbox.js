...
var args58882 = [];
var len__45375__auto___58888 = arguments.length;
var i__45376__auto___58889 = (0);
while(true){
if((i__45376__auto___58889 < len__45375__auto___58888)){
args58882.push((arguments[i__45376__auto___58889]));

var G__58890 = (i__45376__auto___58889 + (1));
i__45376__auto___58889 = G__58890;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args58882.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox58885 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox58885 = (function (obj,header,style,tag,meta58886){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox58885.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_58887,meta58886__$1){
var self__ = this;
var _58887__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox58885(self__.obj,self__.header,self__.style,self__.tag,meta58886__$1));
});

devtools.toolbox.t_devtools$toolbox58885.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_58887){
var self__ = this;
var _58887__$1 = this;
return self__.meta58886;
});

devtools.toolbox.t_devtools$toolbox58885.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL;

devtools.toolbox.t_devtools$toolbox58885.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox58885.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox58885.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox58885.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta58886","meta58886",1920047497,null)], null);
});

devtools.toolbox.t_devtools$toolbox58885.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox58885.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox58885";

devtools.toolbox.t_devtools$toolbox58885.cljs$lang$ctorPrWriter = (function (this__44873__auto__,writer__44874__auto__,opt__44875__auto__){
return cljs.core._write.call(null,writer__44874__auto__,"devtools.toolbox/t_devtools$toolbox58885");
});

devtools.toolbox.__GT_t_devtools$toolbox58885 = (function devtools$toolbox$__GT_t_devtools$toolbox58885(obj__$1,header__$1,style__$1,tag__$1,meta58886){
return (new devtools.toolbox.t_devtools$toolbox58885(obj__$1,header__$1,style__$1,tag__$1,meta58886));
});

}

return (new devtools.toolbox.t_devtools$toolbox58885(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1476916486563