...
var G__67365 = devtools.prefs.pref.call(null,v);
v = G__67365;
continue;
} else {
return v;
...
var and__44255__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__44255__auto__){
var and__44255__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__44267__auto__ = (function (){try{if(!((value == null))){
...
}catch (e67378){var e__65018__auto__ = e67378;
return false;
}})();
if(cljs.core.truth_(or__44267__auto__)){
return or__44267__auto__;
} else {
var or__44267__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e67382){var e__65018__auto__ = e67382;
return false;
}})();
...
}catch (e67384){var e__65018__auto__ = e67384;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__44255__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__44255__auto__)){
var and__44255__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__44255__auto____$1){
...
var and__44255__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__44255__auto__)){
...
var or__44267__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__44267__auto__)){
return or__44267__auto__;
} else {
...
var and__44255__auto__ = (function (){var or__44267__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__44267__auto__)){
return or__44267__auto__;
} else {
...
var vec__67389 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__67389,(0),null);
var name = cljs.core.nth.call(null,vec__67389,(1),null);
...
var and__44255__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__44255__auto__)){
...
var or__44267__auto__ = typeof value === 'string';
if(or__44267__auto__){
return or__44267__auto__;
} else {
var or__44267__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__67392_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__67392_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1476929182183