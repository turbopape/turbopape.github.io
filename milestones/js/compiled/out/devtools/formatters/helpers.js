...
var G__58371 = devtools.prefs.pref.call(null,v);
v = G__58371;
continue;
} else {
return v;
...
}catch (e58384){var e__55975__auto__ = e58384;
return false;
}})();
...
}catch (e58388){var e__55975__auto__ = e58388;
return false;
}})();
...
}catch (e58390){var e__55975__auto__ = e58390;
return false;
}}
}
});
...
var vec__58395 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__58395,(0),null);
var name = cljs.core.nth.call(null,vec__58395,(1),null);
...
return cljs.core.some.call(null,(function (p1__58398_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__58398_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1476916485156