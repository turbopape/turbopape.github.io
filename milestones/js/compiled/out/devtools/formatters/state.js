...
var len__45375__auto___58403 = arguments.length;
var i__45376__auto___58404 = (0);
while(true){
if((i__45376__auto___58404 < len__45375__auto___58403)){
args__45382__auto__.push((arguments[i__45376__auto___58404]));

var G__58405 = (i__45376__auto___58404 + (1));
i__45376__auto___58404 = G__58405;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45383__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq58401){
var G__58402 = cljs.core.first.call(null,seq58401);
var seq58401__$1 = cljs.core.next.call(null,seq58401);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__58402,seq58401__$1);
});
...
return (function (p1__58406_SHARP_){
return (p1__58406_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1476916485211