...
var file = cljs.core.get.call(null,map__59170__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__59170__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__59170__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__4655__auto___59172 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___59172)){
var seen_errors_59173 = temp__4655__auto___59172;
if(cljs.core.truth_(seen_errors_59173.has(self))){
} else {
seen_errors_59173.add(self);

var temp__4657__auto___59174 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___59174)){
var sense_59175 = temp__4657__auto___59174;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_59175)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1476916487166