...
return cljs.core.reduce.call(null,(function (result,p__58117){
var vec__58118 = p__58117;
var k = cljs.core.nth.call(null,vec__58118,(0),null);
var v = cljs.core.nth.call(null,vec__58118,(1),null);
...
var vec__58124 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__58124,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__58124,(1),null);
var ab = cljs.core.nth.call(null,vec__58124,(2),null);
...
var args58127 = [];
var len__45375__auto___58130 = arguments.length;
var i__45376__auto___58131 = (0);
while(true){
if((i__45376__auto___58131 < len__45375__auto___58130)){
args58127.push((arguments[i__45376__auto___58131]));

var G__58132 = (i__45376__auto___58131 + (1));
i__45376__auto___58131 = G__58132;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args58127.length)].join('')));
...
var x__44930__auto__ = (((x == null))?null:x);
var m__44931__auto__ = (clojure.data.equality_partition[goog.typeOf(x__44930__auto__)]);
if(!((m__44931__auto__ == null))){
return m__44931__auto__.call(null,x);
} else {
var m__44931__auto____$1 = (clojure.data.equality_partition["_"]);
if(!((m__44931__auto____$1 == null))){
return m__44931__auto____$1.call(null,x);
} else {
...
var x__44930__auto__ = (((a == null))?null:a);
var m__44931__auto__ = (clojure.data.diff_similar[goog.typeOf(x__44930__auto__)]);
if(!((m__44931__auto__ == null))){
return m__44931__auto__.call(null,a,b);
} else {
var m__44931__auto____$1 = (clojure.data.diff_similar["_"]);
if(!((m__44931__auto____$1 == null))){
return m__44931__auto____$1.call(null,a,b);
} else {
...
return (function (){var G__58137 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__58137) {
case "atom":
...
//# sourceMappingURL=data.js.map?rel=1476916484339