...
return cljs.core.sort_by.call(null,cljs.core.comp.call(null,new cljs.core.Keyword(null,"idx","idx",1053688473),scheje.unifier.get_symbol_idx,cljs.core.str),cljs.core._GT_,cljs.core.map.call(null,(function (p1__14603_SHARP_){
return cljs.core.get.call(null,p1__14603_SHARP_,(0));
...
var temp__4655__auto__ = cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__14604_SHARP_){
return cljs.core._EQ_.call(null,[cljs.core.str(x)].join(''),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(scheje.unifier.get_symbol_idx.call(null,[cljs.core.str(p1__14604_SHARP_)].join(''))));
}),some_matches));
...
return scheje.expander.get_ordered_symbols_for.call(null,p1__14605_SHARP_,a_match);
});})(syms))
,syms);
...
var G__14606 = cljs.core.map.call(null,cljs.core.rest,remaining);
var G__14607 = cljs.core.conj.call(null,res,scheje.expander.generate_exp.call(null,exp,cljs.core.map.call(null,cljs.core.first,remaining)));
remaining = G__14606;
res = G__14607;
continue;
}
...
//# sourceMappingURL=expander.js.map?rel=1455105324385