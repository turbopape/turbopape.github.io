...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__15588 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__15588,ch);
...
if(("\\" === ch__$1)){
var ch_15589__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_15589__$2 == null)){
cljs.tools.reader.reader_types.reader_error.call(null,rdr,"EOF while reading regex");
} else {
}

sb.append(ch_15589__$2);
} else {
}

var G__15590 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__15590;
continue;
}
}
...
var args15591 = [];
var len__14245__auto___15594 = arguments.length;
var i__14246__auto___15595 = (0);
while(true){
if((i__14246__auto___15595 < len__14245__auto___15594)){
args15591.push((arguments[i__14246__auto___15595]));

var G__15596 = (i__14246__auto___15595 + (1));
i__14246__auto___15595 = G__15596;
continue;
} else {
}
break;
...
var vec__15603 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__15603,(0),null);
var start_column = cljs.core.nth.call(null,vec__15603,(1),null);
...
var G__15604 = cljs.core.conj_BANG_.call(null,a,form);
a = G__15604;
continue;
}
}
...
var _STAR_read_delim_STAR_15606 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_15606;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__15609 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__15609,(0),null);
var start_column = cljs.core.nth.call(null,vec__15609,(1),null);
var the_list = cljs.tools.reader.read_delimited.call(null,")",rdr,opts,pending_forms);
var vec__15610 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__15610,(0),null);
var end_column = cljs.core.nth.call(null,vec__15610,(1),null);
...
var vec__15613 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__15613,(0),null);
var start_column = cljs.core.nth.call(null,vec__15613,(1),null);
var the_vector = cljs.tools.reader.read_delimited.call(null,"]",rdr,opts,pending_forms);
var vec__15614 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__15614,(0),null);
var end_column = cljs.core.nth.call(null,vec__15614,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__15617,(0),null);
var start_column = cljs.core.nth.call(null,vec__15617,(1),null);
...
var vec__15618 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__15618,(0),null);
var end_column = cljs.core.nth.call(null,vec__15618,(1),null);
...
var sb = (function (){var G__15621 = (new goog.string.StringBuffer());
G__15621.append(initch);
...
var G__15623 = (function (){var G__15622 = sb;
G__15622.append(ch);

return G__15622;
})();
var G__15624 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__15623;
ch = G__15624;
continue;
}
...
switch (G__15631) {
case "\\":
var G__15635 = (function (){var G__15632 = sb;
G__15632.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__15632;
})();
var G__15636 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__15635;
ch = G__15636;
continue;
...
break;
default:
var G__15637 = (function (){var G__15633 = sb;
G__15633.append(ch);
...
var vec__15640 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__15640,(0),null);
var end_column = cljs.core.nth.call(null,vec__15640,(1),null);
...
var vec__15643 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__15643,(0),null);
var column = cljs.core.nth.call(null,vec__15643,(1),null);
...
var vec__15652 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__15652,(0),null);
var column = cljs.core.nth.call(null,vec__15652,(1),null);
...
var vec__15655 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__15655,(0),null);
var column = cljs.core.nth.call(null,vec__15655,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.reader_types.reader_error.call(null,rdr,"Metadata must be Symbol, Keyword, String or Map");
...
var vec__15660 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__15660,(0),null);
var start_column = cljs.core.nth.call(null,vec__15660,(1),null);
var start_column__$1 = (cljs.core.truth_(start_column)?((start_column - (1)) | (0)):null);
var the_set = cljs.core.set.call(null,cljs.tools.reader.read_delimited.call(null,"}",rdr,opts,pending_forms));
var vec__15661 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__15661,(0),null);
var end_column = cljs.core.nth.call(null,vec__15661,(1),null);
...
var G__15663 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__15663,true,null,opts,pending_forms);
...
var _STAR_suppress_read_STAR_15665 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_15665;
}});
...
var G__15667 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__15667,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__15667,rdr,first_line);
...
var G__15672 = matched;
var G__15673 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__15672;
finished = G__15673;
continue;
} else {
...
var _STAR_suppress_read_STAR_15675 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_15675;
}}
} else {
return cljs.tools.reader.reader_types.reader_error.call(null,rdr,"EOF while reading character");
}
...
var arg_env15678 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__15679 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__15679,"(");
...
var G__15680 = (i + (1));
var G__15681 = cljs.core.conj_BANG_.call(null,args,(function (){var or__13187__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__13187__auto__)){
return or__13187__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env15678;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__15683 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__15683);
...
var G__15684 = cljs.core.next.call(null,s__$1);
var G__15685 = ret;
s__$1 = G__15684;
r = G__15685;
continue;
...
var G__15686 = cljs.core.next.call(null,s);
var G__15687 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__15686;
key_vals = G__15687;
continue;
} else {
...
var gensym_env15695 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env15695;
}});
...
var args15702 = [];
var len__14245__auto___15706 = arguments.length;
var i__14246__auto___15707 = (0);
while(true){
if((i__14246__auto___15707 < len__14245__auto___15706)){
args15702.push((arguments[i__14246__auto___15707]));

var G__15708 = (i__14246__auto___15707 + (1));
i__14246__auto___15707 = G__15708;
continue;
} else {
}
break;
...
}catch (e15705){if((e15705 instanceof Error)){
var e = e15705;
...
var args15710 = [];
var len__14245__auto___15716 = arguments.length;
var i__14246__auto___15717 = (0);
while(true){
if((i__14246__auto___15717 < len__14245__auto___15716)){
args15710.push((arguments[i__14246__auto___15717]));

var G__15718 = (i__14246__auto___15717 + (1));
i__14246__auto___15717 = G__15718;
continue;
} else {
}
break;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__15713,reader){
...
var eof = cljs.core.get.call(null,map__15714__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var args15720 = [];
var len__14245__auto___15723 = arguments.length;
var i__14246__auto___15724 = (0);
while(true){
if((i__14246__auto___15724 < len__14245__auto___15723)){
args15720.push((arguments[i__14246__auto___15724]));

var G__15725 = (i__14246__auto___15724 + (1));
i__14246__auto___15724 = G__15725;
continue;
} else {
}
break;
...
//# sourceMappingURL=reader.js.map?rel=1464515096200