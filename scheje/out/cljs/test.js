...
var args16240 = [];
var len__14245__auto___16244 = arguments.length;
var i__14246__auto___16245 = (0);
while(true){
if((i__14246__auto___16245 < len__14245__auto___16244)){
args16240.push((arguments[i__14246__auto___16245]));

var G__16246 = (i__14246__auto___16245 + (1));
i__14246__auto___16245 = G__16246;
continue;
} else {
}
break;
...
var G__16243 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__16243,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__16243;
}
});
...
var len__14245__auto___16251 = arguments.length;
var i__14246__auto___16252 = (0);
while(true){
if((i__14246__auto___16252 < len__14245__auto___16251)){
args__14252__auto__.push((arguments[i__14246__auto___16252]));

var G__16253 = (i__14246__auto___16252 + (1));
i__14246__auto___16252 = G__16253;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq16248){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__16249,G__16250,seq16248__$2);
});
...
var file = cljs.core.get.call(null,map__16257__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__16257__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__16257__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__16257,map__16257__$1,file,line,column){
return (function (p1__16254_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__16254_SHARP_));
});})(map__16257,map__16257__$1,file,line,column))
...
var temp__4657__auto___16259 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___16259)){
var message_16260 = temp__4657__auto___16259;
cljs.core.println.call(null,message_16260);
} else {
}
...
var temp__4657__auto___16261 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___16261)){
var message_16262 = temp__4657__auto___16261;
cljs.core.println.call(null,message_16262);
} else {
}
...
var G__16268 = exception.stack;
var G__16268__$1 = (((G__16268 == null))?null:clojure.string.split_lines.call(null,G__16268));
var G__16268__$2 = (((G__16268__$1 == null))?null:cljs.core.get.call(null,G__16268__$1,depth));
if((G__16268__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__16268__$2);
}
} else {
...
var vec__16269 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__16269,(0),null);
var column = cljs.core.nth.call(null,vec__16269,(1),null);
var vec__16270 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__16270,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__16270,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__16270,(2),null);
...
var m__$1 = (function (){var G__16272 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__16272) {
case "fail":
...
var G__16278 = (function (){var G__16277 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__16277);
} else {
return G__16277;
}
})();
...
return cljs.core.vary_meta.call(null,G__16280,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e16283){var e = e16283;
var G__16284 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__16284) {
...
var vec__16287 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__16287,(0),null);
var types = vec__16287;
...
var ns = cljs.core.nth.call(null,vec__16296,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__16296,(1),null);
return ((function (vec__16296,ns,vars__$1){
return (function (){
...
var G__16297 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__16297) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__16297,env,once_fixtures,each_fixtures,vec__16296,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__16297,env,once_fixtures,each_fixtures,vec__16296,ns,vars__$1){
return (function (){
var seq__16298 = cljs.core.seq.call(null,vars__$1);
var chunk__16299 = null;
var count__16300 = (0);
var i__16301 = (0);
while(true){
if((i__16301 < count__16300)){
var v = cljs.core._nth.call(null,chunk__16299,i__16301);
var temp__4657__auto___16303 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___16303)){
var t_16304 = temp__4657__auto___16303;
each_fixture_fn.call(null,((function (seq__16298,chunk__16299,count__16300,i__16301,t_16304,temp__4657__auto___16303,v,each_fixture_fn,G__16297,env,once_fixtures,each_fixtures,vec__16296,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_16304)));
});})(seq__16298,chunk__16299,count__16300,i__16301,t_16304,temp__4657__auto___16303,v,each_fixture_fn,G__16297,env,once_fixtures,each_fixtures,vec__16296,ns,vars__$1))
);
} else {
}

var G__16305 = seq__16298;
var G__16306 = chunk__16299;
var G__16307 = count__16300;
var G__16308 = (i__16301 + (1));
seq__16298 = G__16305;
chunk__16299 = G__16306;
count__16300 = G__16307;
i__16301 = G__16308;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__16298);
if(temp__4657__auto__){
var seq__16298__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__16298__$1)){
var c__13990__auto__ = cljs.core.chunk_first.call(null,seq__16298__$1);
var G__16309 = cljs.core.chunk_rest.call(null,seq__16298__$1);
var G__16310 = c__13990__auto__;
var G__16311 = cljs.core.count.call(null,c__13990__auto__);
var G__16312 = (0);
seq__16298 = G__16309;
chunk__16299 = G__16310;
count__16300 = G__16311;
i__16301 = G__16312;
continue;
} else {
var v = cljs.core.first.call(null,seq__16298__$1);
var temp__4657__auto___16313__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___16313__$1)){
var t_16314 = temp__4657__auto___16313__$1;
each_fixture_fn.call(null,((function (seq__16298,chunk__16299,count__16300,i__16301,t_16314,temp__4657__auto___16313__$1,v,seq__16298__$1,temp__4657__auto__,each_fixture_fn,G__16297,env,once_fixtures,each_fixtures,vec__16296,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_16314)));
});})(seq__16298,chunk__16299,count__16300,i__16301,t_16314,temp__4657__auto___16313__$1,v,seq__16298__$1,temp__4657__auto__,each_fixture_fn,G__16297,env,once_fixtures,each_fixtures,vec__16296,ns,vars__$1))
);
} else {
}

var G__16315 = cljs.core.next.call(null,seq__16298__$1);
var G__16316 = null;
var G__16317 = (0);
var G__16318 = (0);
seq__16298 = G__16315;
...
});})(each_fixture_fn,G__16297,env,once_fixtures,each_fixtures,vec__16296,ns,vars__$1))
);
});})(each_fixture_fn,G__16297,env,once_fixtures,each_fixtures,vec__16296,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1455204570559